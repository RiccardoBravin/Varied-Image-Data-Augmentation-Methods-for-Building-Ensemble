...
try
    ...
    for pattern = interval
        ...
        [IND,map] = rgb2ind(img, randi([2,4]),'nodither');
        Oimg = uint8(ind2rgb(IND,map)*255);
...
clearvars i pattern img append iterations interval IND map Oimg
